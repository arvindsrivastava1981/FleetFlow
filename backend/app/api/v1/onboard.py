...
from backend.app.db.queries.users import create_user, get_user_by_id
...
async def api_self_onboard_fleet(request: Request):
    """Self-serve fleet creation for fleet-less users (e.g. social sign-ups).
    ...
    Users who already have a fleet get 409 — Super Admins keep the full
    ``/fleets/onboard`` wizard for creating firms on behalf of others.
    """
