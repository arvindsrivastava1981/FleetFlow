...
def rule_engine_page(request: Request):
    ...
    <html lang="en"><head><meta charset="UTF-8"><meta name="viewport" content="width=device-width, initial-scale=1.0"><title>VahanKhata Rule Engine</title><script src="https://cdn.tailwindcss.com"></script></head>
