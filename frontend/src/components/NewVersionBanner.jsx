 ...
 * Cache Storage entries and hard-reloads — users never need to manually clear
 * their browser cache to see new changes.
 */
  ...
  return (
    ...
    >
      ...
      <button
        type="button"
        onClick={reload}
        aria-label="Reload app to load the new version"
