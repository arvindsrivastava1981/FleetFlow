...
VALUES (
    ...
    'UP-93-AT-1234', 'Ramesh Kumar', '+91 98765 43210', 25000.00, 102400.00, 102850.00, 'ACTIVE'
)
...
VALUES 
    ...
    ((SELECT id FROM trips WHERE trip_code = 'TRIP-101'), 'TRIP-101', 'TOLL', 850.00, 0.00, 0.00, 102750.00, 'NH-19 Toll Plaza', TRUE, 'Cash claimed on 100% FASTag corridor', 'PENDING'),
    ((SELECT id FROM trips WHERE trip_code = 'TRIP-101'), 'TRIP-101', 'FUEL', 5400.00, 60.00, 90.00, 102850.00, 'HPCL Fuel Stop', TRUE, 'Low mileage 1.7 km/L (Expected ~4.0 km/L)', 'PENDING');
